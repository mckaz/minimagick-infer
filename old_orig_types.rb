...
RDL.orig_type Object.const_get('MiniMagick::Tool'), '<<', '() -> self', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Tool'), 'merge!', '() -> self', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Tool'), '+', '() -> self', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('MiniMagick::Image'), 'self.read', '(String, String) -> MiniMagick::Image', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('MiniMagick::Image'), 'format', '(String, Integer, Hash) -> self', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Image'), 'combine_options', '() -> self', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Image'), 'method_missing', '() -> self', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Image'), 'respond_to_missing?', '() -> %bool', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Image'), 'write', '(String or Pathname) -> %bot', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Image'), 'composite', '() -> %bot', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('MiniMagick::Image'), 'collapse!', '(Integer) -> self', wrap: false, typecheck: :later
